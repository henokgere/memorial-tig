    ...
    return (
      <div className="max-w-6xl mx-auto px-4 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-3xl md:text-4xl font-bold mb-4">Connect & Support</h1>
                ...
                >
                  <div className="bg-white p-2 rounded-md mr-4">
                    <svg className="w-8 h-8 text-green-600" viewBox="0 0 24 24">
                      <path fill="currentColor" d="M18 12.5a1.5 1.5 0 1 1-1.5-1.5 1.5 1.5 0 0 1 1.5 1.5Zm-3.5-1.5a1.5 1.5 0 1 0 1.5 1.5 1.5 1.5 0 0 0-1.5-1.5Zm-5 0a1.5 1.5 0 1 0 1.5 1.5 1.5 1.5 0 0 0-1.5-1.5Zm-3.5 1.5a1.5 1.5 0 1 0-1.5-1.5 1.5 1.5 0 0 0 1.5 1.5ZM12 2a10 10 0 1 0 10 10A10 10 0 0 0 12 2Zm0 18a8 8 0 1 1 8-8 8 8 0 0 1-8 8Z"/>
                    </svg>
                  </div>
                  <div>
                ...
                >
                  <div className="bg-white p-2 rounded-md mr-4">
                    <svg className="w-8 h-8 text-blue-600" viewBox="0 0 24 24">
                      <path fill="currentColor" d="M10 13l2 5 2-5h4l-4-8-4 8h4z"/>
                    </svg>
                  </div>
                  <div>
              ...
              <div className="grid grid-cols-2 gap-4">
                {[
                  { 
                    ...
                    handle: '@mit_leganu',
                    url: 'https://twitter.com/mit_leganu'
                  },
                  { 
                    name: 'Instagram', 
                    icon: (
                    ...
                    handle: '@mit_leganu',
                    url: 'https://instagram.com/mit_leganu'
                  },
                  { 
                    name: 'Telegram', 
                    icon: (
                    ...
                    handle: 't.me/mit_leganu',
                    url: 'https://t.me/mit_leganu'
                  },
                  { 
                    name: 'Facebook', 
                    icon: (
                    ...
                    handle: 'fb.com/mit_leganu',
                    url: 'https://facebook.com/mit_leganu'
                  }
                ].map((social, index) => (
                  <a 
                    key={index}

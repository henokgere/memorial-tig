  ...
  return (
    <section className="relative h-[450px] my-8 flex items-center justify-center bg-memorial-dark text-white overflow-hidden">
      ...
      <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
        ...
        <h2 className="text-2xl md:text-4xl mb-6 animate-fadeIn delay-100">
          Lost in the Tigray War
        </h2>
        
        <p className="text-lg md:text-xl italic mb-8 max-w-2xl mx-auto animate-fadeIn delay-200">
        ...
        <div className="flex flex-col md:flex-row justify-center gap-4 animate-fadeIn delay-300">
          <a 
            href="/our-heroes" 
            className="px-6 py-3 bg-red-700 hover:bg-[#505050] rounded-lg transition text-white font-semibold"
          >
            View Memorial
          </a>
          <a 
            href="/donate" 
            className="px-6 py-3 bg-[#505050] hover:bg-red-700 rounded-lg transition text-white font-semibold"
          >
            Donate Now
          </a>
        </div>
